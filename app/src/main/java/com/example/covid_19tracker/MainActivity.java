...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView todayConfirm, todayRecovered, todayDeath, todayActive, dateTV;
            ...
            public void onResponse(Call<List<CountryData>> call, Response<List<CountryData>> response) {
                ...
                for (int i = 0; i<list.size(); i++){
                    if(list.get(i).getCountry().equals("India")){
                        ...
                        todayActive.setText(NumberFormat.getInstance().format(Integer.parseInt(list.get(i).getTodayActive())));
                        todayActive.setText("0");
                        setText(list.get(i).getUpdated());

                        pieChart.addPieSlice(new PieModel("Confirm",confirm,getResources().getColor(R.color.yellow)));
                        pieChart.addPieSlice(new PieModel("Active",confirm,getResources().getColor(R.color.blue_pie)));
